...
<html lang="ru">
  ...
  <body class="front-page">
    ...
    <header class="header header-image">
      <div class="container">
        <div class="header-content">
          ...
          <div class="button2">
            <div class="button2-text">Подробнее о компании</div>
          </div>
        </div>
        ...
        <div class="swiper features-slider">
          <ul class="swiper-wrapper header-features">
            ...
            <li class="swiper-slide header-features-item">
              <svg width="36" height="36">
                <use href="img/sprite.svg#cert"></use>
              </svg>
              <p class="header-features-text">Вся продукция сертифицирована</p>
            </li>
            <li class="swiper-slide header-features-item">
              <svg width="36" height="36">
                <use href="img/sprite.svg#chel"></use>
              </svg>
    ...
    <section
      ...
      style="margin-bottom: 110px; margin-top: 90px"
    >
      <div class="container">
        <div class="seporator"></div>
        ...
        <div class="swiper steps-slider">
          ...
          <ol class="swiper-wrapper steps">
            ...
            <li class="swiper-slide steps-item">
              ...
              <p class="steps-text" style="margin-left: -1px; margin-top: -7px">
            ...
            <li class="swiper-slide steps-item">
              <span class="steps-num" style="margin-left: -0.4375rem">02</span>
              <h3 class="steps-title" style="margin-left: -0.5rem">
                Заключение договора
              </h3>
              <p
                class="steps-text"
            ...
            <li class="swiper-slide steps-item">
              <span
                class="steps-num"
                style="margin-left: -0.875rem; margin-top: 0px"
                >03</span
              >
              <h3 class="steps-title" style="margin-left: -14px">
                Производство
              </h3>
              <p
                class="steps-text"
                style="margin-left: -0.8125rem; margin-top: -0.5rem"
              >
            ...
            <li class="swiper-slide steps-item">
              <span
                class="steps-num"
                style="margin-left: -1.25rem; margin-top: 0rem"
                >04</span
              >
              <h3 class="steps-title" style="margin-left: -20px">Доставка</h3>
              <p
                class="steps-text"
                style="margin-left: -1.25rem; margin-top: -0.5rem"
              >
    ...
    <section class="section production" style="margin-top: 110px">
      <div class="container">
        <div class="seporator"></div>
    ...
    <section class="section trademark" style="margin-top: 150px">
      <div class="container">
        <div class="seporator"></div>
      ...
      <div class="container">
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            margin-bottom: 24px;
            max-width: 365px;
        ">Отношение к делу и к клиентам</h2>
            <p class="founder-text"style="
            margin-left: 9px;
            margin-bottom: 23px;
        ">
              ...
              массового участия. <p class="founder-text"style="margin-left: 10px; margin-top:20px;margin-bottom: 35px;" >
            ...
            <a href="#" class="button-link"style="
            margin-left: 8px;
    ...
    <section class="section clients" style="margin-top: 6.25rem">
      <div class="container">
        <div class="seporator" style="margin-bottom: 35px"></div>
            ...
            <ul class="clients-list">
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#him"></use></svg>Химические производства
              </li>

              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#car1"></use></svg>Автомойки
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#eat"></use></svg>Пищевая продукция
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#brush"></use></svg>Лаки и краски
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#cosmetic"></use></svg>Косметические средства
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#сar-cosm"></use></svg>Автомобильная косметика
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#shirt"></use></svg>Косметика по уходу за одеждой
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#boots"></use></svg>Косметика по уходу за обувью
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#bricks"></use></svg>Строительные материалы
              </li>
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#more"></use></svg>И многих других
              </li>
            </ul>
          </div>
    ...
    <section class="section blog">
      <div class="container">
        <div class="seporator" style="
        margin-top: 145px;
    "></div>
        <h2 class="section-title"style="
        margin-bottom: 55px;
        margin-left: 15px;
    ">Блог экспертов в области производства</h2>
        <!-- Slider main container -->
<div class="swiper blog-slider">
  <!-- Additional required wrapper -->
  <div class="swiper-wrapper swd" >
    <!-- Slides -->
    <a href="#" class="swiper-slide blog-card">   
      <img src="img/blog/blog-photo.jpg" alt="" class="blog-card-image"><h3 class="blog-card-title"
  >
    ...
    <a href="#" class="swiper-slide blog-card">   
      <img src="img/blog/blog-post.jpg" alt="" class="blog-card-image"><h3 class="blog-card-title">
